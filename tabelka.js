function add_row() {
    var new_lp = document.getElementById("new_lp").value; //pobiera KAŻDY element html o podanym id
    var new_name = document.getElementById("new_name").value; //value element DOM, przypisanie wartości
    ...
    var table_len = (table.rows.length) - 1; //wykonuję metodę od ostatniego pobranego elementu tablicy -1
...
//insertRow jest to metoda umożliwiająca dodawanie wiersza do tabeli, outerHTML element DOM, zawiera znacznik aktualnego elementu i kod HTML, który zawiera znacznik.
